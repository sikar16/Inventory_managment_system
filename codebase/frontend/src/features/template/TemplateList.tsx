...
export default function TemplateList() {
  ...
  return (
    <div className="mx-10 mt-10 dark:bg-[#002A47] text-[#002A47] bg-[#edf0fc] dark:text-[#edf0fc]">
      ...
      <div className="flex mx-[7%] dark:bg-[#002A47] text-[#002A47] bg-[#edf0fc] dark:text-[#edf0fc]">
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        <div className="flex justify-between me-5 dark:bg-[#002A47] text-[#002A47] bg-[#edf0fc] dark:text-[#edf0fc]">
