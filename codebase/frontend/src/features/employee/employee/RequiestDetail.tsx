...
const columns = [
  ...
  { id: "product", label: "Product", minWidth: 70, align: "left" as const },
  { id: "quantity", label: "Quantity", minWidth: 70, align: "left" as const },
  { id: "unit", label: "Unit", minWidth: 70, align: "left" as const },
  { id: "remark", label: "Remark", minWidth: 70, align: "left" as const },
  {
    id: "dateOfRequest",
...
const rows: RowData[] = [
  createData(1, "Electronics", "Hp laptop", "20", "pieces", "...", "8-26-2024"),
...
const RequestDetail: React.FC = () => {
  ...
  return (
    <div>
      ...
      <h2 className="bg-[#002a47] text-white py-2.5 px-2 rounded-e-full mb-5">
                    ...
                    <div className="space-y-4 w-[85%] justify-center m-auto p-5">
                      ...
                      <div className="flex justify-between gap-4">
                        ...
                        <p className="text-gray-600">
                          ...
                          elit. Doloribus, voluptate nihil voluptas neque
                          possimus fugit officia dolorem nostrum optio odit.
                        </p>
                      </div>
                    </div>
                  </td>
