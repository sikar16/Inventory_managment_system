...
const AddTemplate: React.FC<AddTemplateProps> = ({ handleCloseDialog }) => {
  ...
  const {
    ...
    data: templates = [],
  } = useGetAlltemplateQuery("get all template");
  ...
  if (isTemplateError)
    return <div>Error loading templates: {`${isTemplateError}`}</div>;
    ...
    <div className="mx-10 mb-10">
      <form className="space-y-2">
        ...
        <Select
          ...
          onChange={handleSelectChange} // This now uses the correct handler
        >
