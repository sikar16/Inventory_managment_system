...
export default function SupplierCategoryList() {
  ...
  const { data: categories } = useGetAllsupplierCategoryQuery(
    "get all supplayer category"
  );
  ...
  if (isSuccess)
    return (
      <div className="mt-10 ">
        ...
        <SupplierCategoryTable suppliersCategorylist={data} />
