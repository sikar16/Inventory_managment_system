...
import Button from "@mui/material/Button"; // Ensure this import is present
...
const columns = [
  ...
  { id: "status", label: "Status", minWidth: 70, align: "left" as const },
  {
    id: "dateOfRequest",
...
const rows: RowData[] = [
  ...
  createData(2, "#12346", "Alice", "Dell laptop", "15", "Pending", "8-27-2024"),
