...
const MaterialRequestForm = () => {
  ...
  return (
    <div className="container mx-auto px-6 bg-white rounded-lg">
      <div className="mb-10">
        <h3 className="text-lg font-medium text-gray-700 mb-4 underline-offset-1">
          Request lists
        </h3>
        <table className="w-full border border-gray-300 rounded-lg">
          <thead className="bg-gray-50">
            <tr>
              <td className="border px-4 py-2 text-left text-gray-600">
                Products
              </td>
              <td className="border px-4 py-2 text-left text-gray-600">
                Quantity
              ...
              {requests.map((req, index) => (
                <tr key={index} className="hover:bg-gray-100">
                  <td className="border px-4 py-2">
                    {productsData[req.subcategory]
                      ?.filter((product) => req.products.includes(product.id))
      ...
      {isAddProductOpen && (
        <div>
          ...
          <AddProduct
            ...
            productCategorys={undefined}
            templates={undefined}
            productSubCategorys={undefined}
            close={function (): void {
              throw new Error("Function not implemented.");
            }}
